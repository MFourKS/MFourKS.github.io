...
<!-- Вывод результатов в виде информ окна-->
<section class="div_all" >

	<div class="div_res"><center><div class="div_in"><a href="#" ><br>Перейти к документу</a> </div></center>
	<br>Приказ №123-123<br><br>От 31.02.1955<br>Совпадение по: </div>
	<div class="div_res"><center><div class="div_in"><a href="#" ><br>Перейти к документу</a> </div></center>
	<br>Приказ №123-123<br><br>От 31.02.1955<br>Совпадение по: </div>
	<div class="div_res"><center><div class="div_in"><a href="#" ><br>Перейти к документу</a> </div></center>
	<br>Приказ №123-123<br><br>От 31.02.1955<br>Совпадение по: </div>
